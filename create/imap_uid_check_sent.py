...
from plpy_stub import notice as pl_notice
from plpy_stub import warning as pl_warning
from plpy_stub import execute as pl_execute
from plpy_stub import SPIError as pl_SPIError
                    ...
                    if db_res == '':
                        ...
                        '''
                            ...
                            if copy_result[0] == 'OK':
                                ...
                                pl_warning(copy_result)
                                ret_result = copy_result
                        '''
                                                    
        else:
            pl_notice('Error reading msg_uid=%s, result=%s' % (msg_uid, result))
...
login = 'no-reply@kipspb.ru'
password = 'Never-adm1n'
folder = 'mailer-daemon'
sender = 'mailer-daemon@yandex.ru'


res = imap_uid_check_sent(
imap_srv,
login,
password,
folder,
